...
export default function WhySyntheticSection() {
  ...
  return (
    ...
    >
      ...
      {/* Content container */}
      <div className="relative z-10 w-full h-full max-w-[1200px] mx-auto px-4 sm:px-8 md:px-16 lg:px-24 pt-4 pb-10 flex flex-col justify-center">
        ...
        <motion.div
          ...
          className="grid grid-cols-3 gap-2 sm:gap-4 mb-4 sm:mb-5"
        >
          {statHighlights.map((stat, i) => (
            <div
              key={i}
              className="relative border border-[#b0741a]/12 bg-white/35 backdrop-blur-[8px] rounded-xl sm:rounded-2xl p-3 sm:p-5 text-center group hover:border-[#b0741a]/30 transition-all duration-500 hover:shadow-[0_12px_40px_rgba(176,116,26,0.06)]"
            >
              {/* Decorative top line */}
              ...
              <span className="block font-serif text-[28px] sm:text-[42px] md:text-[52px] font-medium bg-gradient-to-r from-[#b0741a] via-[#d08f30] to-[#8c540c] bg-clip-text text-transparent leading-tight mb-1 sm:mb-2">
                {stat.value}
              </span>
        ...
        >
          ...
          {comparisonData.map((row, i) => (
            ...
            >
              {/* Attribute */}
              <div className="py-2 sm:py-2.5 px-2 sm:px-8 flex items-center">
              ...
              {/* Natural value */}
              <div className="py-2 sm:py-2.5 px-2 sm:px-8 flex items-center justify-center">
